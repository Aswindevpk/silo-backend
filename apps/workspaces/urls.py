...
urlpatterns = [
    ...
    path("<slug:slug>/members/<int:pk>/",RemoveWorkspaceMemberView.as_view(),name="workspace-member-remove",),
    path("<slug:slug>/invite/", WorkspaceInviteView.as_view(), name="workspace-invite"),
    path("<slug:slug>/invitations/<int:pk>/revoke/",RevokeWorkspaceInvitationView.as_view(),name="workspace-invitation-revoke",),
    path("<slug:slug>/invitations/<int:pk>/resend/",ResendWorkspaceInvitationView.as_view(),name="workspace-invitation-resend",),
